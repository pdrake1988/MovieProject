        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Overview = table.Column<string>(type: "Varchar(200)", nullable: false),
                    Tagline = table.Column<string>(type: "Varchar(512)", nullable: false),
                    ...
                    PosterUrl = table.Column<string>(type: "Varchar(2084)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastMovie", x => new { x.MovieCastId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CastMovie_Cast_MovieCastId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieCrewId = table.Column<int>(type: "int", nullable: false),
                    MoviesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrewMovie", x => new { x.MovieCrewId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CrewMovie_Crew_MovieCrewId",
                        column: x => x.MovieCrewId,
                        principalTable: "Crew",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GenreMovie_Genre_MovieGenresId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseDateTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MovieId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<string>(type: "Varchar(2000)", nullable: false)
                },
                constraints: table =>
                {
